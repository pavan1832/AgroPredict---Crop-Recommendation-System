...
-🚀 Live Demo: https://agropredict-baxe.onrender.com/
...
- Clone the complete project with `git clone https://github.com/pavan1832/AgroPredict---Crop-Recommendation-System.git` or you can just download the code and unzip it
- **Note:** The master branch doesn't have the updated code used for deployment, to download the updated code used for deployment you can use the following command
  ```
  ❯ git clone -b deploy https://github.com/pavan1832/.git 
  ```
